...
public class SecurityConfig {
    ...
    private final String userAttrName;
    ...
    private SecurityConfig(Builder builder) {
        ...
        this.userAttrName = builder.userAttrName;
    }
    ...
    public static Builder create(String userAttrName) {
        return new Builder(userAttrName);
    }
    ...
    static class Builder {
        ...
        public Builder(String userAttrName) {
